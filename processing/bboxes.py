...
def segmentation_masks(
    client, inputPath, outputFolder, parts=None, model: str = "gemini-3-flash-preview"
):
    """
    ...
    for i, item in enumerate(items):
        ...
        mask = mask.resize(
            (abs_x2 - abs_x1, abs_y2 - abs_y1), Image.Resampling.BILINEAR
        )
