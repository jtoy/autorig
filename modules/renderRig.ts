 ...
 */
export function computeCharacterRigData(
    rigData: RigData, 
    ...
    const applyTransform = (parent: Transform2D, local: Transform2D): Transform2D => {
    ...
    if (visibility.head !== false) {
        ...
        const headParentTransform = applyTransform(rootTransform, {
            x: pivotPoint.x || 0,
            y: pivotPoint.y || 0,
            rotation: headRot,
            scaleX: flipHead ? -1 : 1,
        ...
        const headTransform = applyTransform(headParentTransform, {
    ...
    if (visibility.mouth !== false) {
        ...
        const headBaseTransform = applyTransform(rootTransform, {
            x: headPivot.x || 0,
            y: headPivot.y || 0,
            rotation: headRot,
            scaleX: flipHead ? -1 : 1,
        ...
        const mouthTransform = applyTransform(headBaseTransform, {
            x: offsetX,
    ...
    if (visibility.leftEye !== false && loadedImages['eyes.leftEyeImage'] && eyes) {
        ...
        const leftEyeTransform = applyTransform(headBaseTransform, {
            x: offsetX,
            y: offsetY,
            rotation: 0,
            scaleX: 1,
    ...
    if (visibility.rightEye !== false && loadedImages['eyes.rightEyeImage'] && eyes) {
        ...
        const rightEyeTransform = applyTransform(headBaseTransform, {
            x: offsetX,
            y: offsetY,
            rotation: 0,
            scaleX: 1,
    ...
    if (visibility.leftIris !== false && loadedImages['eyes.leftIris'] && eyes) {
        ...
        const leftIrisTransform = applyTransform(headBaseTransform, {
            x: offsetX,
            y: offsetY,
            rotation: 0,
            scaleX: 1,
    ...
    if (visibility.rightIris !== false && loadedImages['eyes.rightIris'] && eyes) {
        ...
        const rightIrisTransform = applyTransform(headBaseTransform, {
            x: offsetX,
            y: offsetY,
            rotation: 0,
            scaleX: 1,
    ...
    if (visibility.leftEyeLid !== false && leftEyeLidImage && eyes) {
        ...
        const leftEyeLidTransform = applyTransform(headBaseTransform, {
            x: offsetX,
            y: offsetY,
            rotation: 0,
            scaleX: 1,
    ...
    if (visibility.rightEyeLid !== false && rightEyeLidImage && eyes) {
        ...
        const rightEyeLidTransform = applyTransform(headBaseTransform, {
            x: offsetX,
            y: offsetY,
            rotation: 0,
            scaleX: 1,
    ...
    if (visibility.leftUpperArm !== false) {
        ...
        const upperArmParentTransform = applyTransform(rootTransform, {
            x: pivotPoint.x || 0,
            y: pivotPoint.y || 0,
            rotation: limbRot,
            scaleX: 1,
        ...
        const upperArmTransform = applyTransform(upperArmParentTransform, {
            x: jointOff.x || 0,
    ...
    if (visibility.leftForearm !== false) {
        ...
        const upperArmBase = applyTransform(rootTransform, {
            x: upperPivot.x || 0,
            y: upperPivot.y || 0,
            rotation: upperRot,
            scaleX: 1,
        ...
        const forearmParent = applyTransform(upperArmBase, {
            x: pivotPoint.x || 0,
        ...
        const forearmTransform = applyTransform(forearmParent, {
            x: jointOff.x || 0,
            y: (jointOff.y || 0) - height / 2,
            rotation: selfRot,
            scaleX: 1,
    ...
    if (visibility.leftHand !== false) {
        ...
        const forearmBase = applyTransform(upperArmBase, {
            x: forePivot.x || 0,
        ...
        const handParent = applyTransform(forearmBase, {
            x: handPivot.x || 0,
        ...
        const handTransform = applyTransform(handParent, {
            x: handJointOff.x || 0,
    ...
    if (visibility.leftThigh !== false) {
        ...
        const thighParentTransform = applyTransform(rootTransform, {
            x: pivotPoint.x || 0,
            y: pivotPoint.y || 0,
            rotation: limbRot,
            scaleX: 1,
        ...
        const thighTransform = applyTransform(thighParentTransform, {
            x: jointOff.x || 0,
            y: (jointOff.y || 0) - height / 2,
            rotation: selfRot,
            scaleX: 1,
    ...
    if (visibility.leftLeg !== false) {
        ...
        const thighBase = applyTransform(rootTransform, {
            x: upperPivot.x || 0,
            y: upperPivot.y || 0,
            rotation: upperRot,
            scaleX: 1,
        ...
        const legParent = applyTransform(thighBase, {
            x: pivotPoint.x || 0,
            y: (pivotPoint.y || 0) - upperHeight,
            rotation: limbRot,
            scaleX: 1,
        ...
        const legTransform = applyTransform(legParent, {
            x: jointOff.x || 0,
            y: (jointOff.y || 0) - height / 2,
            rotation: selfRot,
            scaleX: 1,
    ...
    const headPivotWorld = applyTransform(rootTransform, {
        x: torsoHead.x || 0,
        y: torsoHead.y || 0,
        rotation: 0,
        scaleX: 1,
    ...
    const lShoulderWorld = applyTransform(rootTransform, {
        x: lShoulder.x || 0,
        y: lShoulder.y || 0,
        rotation: 0,
        scaleX: 1,
    ...
    const lElbowBase = applyTransform(rootTransform, {
        x: lShoulder.x || 0,
        y: lShoulder.y || 0,
        rotation: rL1,
        scaleX: 1,
    ...
    const lElbowWorld = applyTransform(lElbowBase, {
        x: lElbowOff.x || 0,
    ...
    const lForearmBase = applyTransform(lElbowBase, {
        x: lElbowOff.x || 0,
        y: (lElbowOff.y || 0) - leftUpperArmHeight,
    ...
    const lWristWorld = applyTransform(lForearmBase, {
        x: lWristOff.x || 0,
    ...
    const rShoulderWorld = applyTransform(rootTransform, {
        x: rShoulder.x || 0,
        y: rShoulder.y || 0,
        rotation: 0,
        scaleX: 1,
    ...
    const rElbowBase = applyTransform(rootTransform, {
        x: rShoulder.x || 0,
        y: rShoulder.y || 0,
        rotation: rR1,
        scaleX: 1,
    ...
    const rElbowWorld = applyTransform(rElbowBase, {
        x: rElbowOff.x || 0,
    ...
    const rForearmBase = applyTransform(rElbowBase, {
        x: rElbowOff.x || 0,
        y: (rElbowOff.y || 0) - rightUpperArmHeight,
    ...
    const rWristWorld = applyTransform(rForearmBase, {
        x: rWristOff.x || 0,
    ...
    const lHipWorld = applyTransform(rootTransform, {
        x: lHip.x || 0,
        y: lHip.y || 0,
        rotation: 0,
        scaleX: 1,
    ...
    const lThighBase = applyTransform(rootTransform, {
        x: lHip.x || 0,
        y: lHip.y || 0,
        rotation: rLT1,
        scaleX: 1,
    ...
    const lKneeWorld = applyTransform(lThighBase, {
        x: lKneeOff.x || 0,
    ...
    const rHipWorld = applyTransform(rootTransform, {
        x: rHip.x || 0,
        y: rHip.y || 0,
        rotation: 0,
        scaleX: 1,
    ...
    const rThighBase = applyTransform(rootTransform, {
        x: rHip.x || 0,
        y: rHip.y || 0,
        rotation: rRT1,
        scaleX: 1,
    ...
    const rKneeWorld = applyTransform(rThighBase, {
        x: rKneeOff.x || 0,
...
/**
 * Legacy Canvas renderer - Uses the computed rig data to render with Canvas 2D
 * This is kept for backwards compatibility but can be replaced with any rendering library
 * If loadedImages is not provided, will use the global image cache
 */
/**
 ...
 * await renderCharacterRig(canvas, rigData, myImages);
 * 
 * @example
 * // Without images - auto-loads if needed (async path)
 * await renderCharacterRig(canvas, rigData);
 */
export async function renderCharacterRig(
    ...
    if (!loadedImages) {
        ...
        if (cache.size === 0) {
            ...
            loadedImages = await loadAllRigImages(rigData, true);
        } else {
            // Use existing cache
            loadedImages = {};
    ...
    const rigRenderData = computeCharacterRigData(rigData, {
...
// Re-export image loading functions as named exports for convenience
export {
    setBaseHost,
    getBaseHost,
    resolveImageSource,
